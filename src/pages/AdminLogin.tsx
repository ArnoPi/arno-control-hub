...
const AdminLogin = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (email === 'admin@test.com' && password === 'admin123') {
        ...
        toast({
          title: "Login Mislukt",
          description: "Ongeldige email of wachtwoord.",
          variant: "destructive",
        });
      }
      setIsLoading(false);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg%20width%3D%2260%22%20height%3D%2260%22%20viewBox%3D%220%200%2060%2060%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%3Cg%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%3E%3Cg%20fill%3D%22%23334155%22%20fill-opacity%3D%220.1%22%3E%3Ccircle%20cx%3D%2230%22%20cy%3D%2230%22%20r%3D%224%22/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-20"></div>
      ...
      <div className="relative w-full max-w-md px-6">
        <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-xl shadow-2xl">
          <CardHeader className="text-center space-y-6">
            ...
            <div>
              ...
              <p className="text-slate-400 mt-2">Toegang tot het beheerssysteem</p>
            </div>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="email" className="text-slate-300">Email Adres</Label>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-slate-500">
            🔒 Beveiligde verbinding • Alle data wordt versleuteld
          </p>
        </div>
      </div>
    </div>
